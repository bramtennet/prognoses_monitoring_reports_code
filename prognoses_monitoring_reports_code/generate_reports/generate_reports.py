...
from prognoses_monitoring_reports_code.visualisation.visualise import (
    ...
    barchart_marketparty_MAE,
    barchart_marketparty_rMAE,
    dist_errors,
    five_conn_MAE,
    five_conn_rMAE,
    MAE_marketparty_month,
    rMAE_marketparty_month,
    connectionpoint_plot,
    plot_year,
    barchart_tennet_MAE,
...
from prognoses_monitoring_reports_code.pdf.create_pdf import (
    ...
    create_pdf_tennet_month,
    create_pdf_tennet_year,
    create_pdf_tennet_wind_month,
...
def generate_report_marketparty_month(
    ...
    for mp in list_market_parties:
        ...
        for i in range(len(list_conn)):
            ...
            df_temp = df_month_party[
                df_month_party["Connection point Name"] == list_conn[i]
            ]
        ...
        conn_dict = dict(
            zip(
                df_month_party["Connection point Name"],
                df_month_party["Connection point EAN"],
            )
        )
...
def generate_report_general_month(year, df_month, month, reports_output_folder):
    ...
    # Generate the PDF report including all the plots
    # =============================================================================
    create_pdf_general_month(year, month, reports_output_folder)


def generate_report_general_year(year, df, reports_output_folder):
    ...
    # PLOT the MAE and rMAE during the month for both the ID and DA
    # =============================================================================
    plot_year(year, df, "MAE", reports_output_folder)
    plot_year(year, df, "rMAE", reports_output_folder)

    # =============================================================================
    # Generate the PDF report including all the plots
    # =============================================================================
    create_pdf_general_year(year)


def generate_report_internal_month(
    year, df_month, month, reports_output_folder, missing_eans_per_pv=None
):
    """This function generates a comparison report for all market parties for a specific month with visible names(intended for internal use only)
    ...
    # Generate the PDF report including all the plots
    # =============================================================================
    create_pdf_tennet_month(year, month, reports_output_folder, missing_eans_per_pv)


def generate_report_internal_year(year, df, reports_output_folder):
    """This function generates a comparison report for all market parties for a specific month with visible names(intended for internal use only)
    ...
    # Generate the PDF report including all the plots
    # =============================================================================
    create_pdf_tennet_year(year, reports_output_folder)
